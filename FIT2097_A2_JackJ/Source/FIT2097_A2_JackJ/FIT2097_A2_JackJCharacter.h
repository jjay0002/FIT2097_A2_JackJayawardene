...
#include "FIT2097_A2_JackJCharacter.generated.h"

class UInputComponent;

UCLASS(config=Game)
class AFIT2097_A2_JackJCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class AFIT2097_A2_JackJProjectile> ProjectileClass;
