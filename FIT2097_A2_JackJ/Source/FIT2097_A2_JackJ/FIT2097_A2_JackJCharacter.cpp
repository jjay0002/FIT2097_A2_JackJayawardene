...
//////////////////////////////////////////////////////////////////////////
// AFIT2097_A2_JackJCharacter

AFIT2097_A2_JackJCharacter::AFIT2097_A2_JackJCharacter()
{
...
void AFIT2097_A2_JackJCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AFIT2097_A2_JackJCharacter::OnResetVR);

	// Bind movement events
	PlayerInputComponent->BindAxis("MoveForward", this, &AFIT2097_A2_JackJCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AFIT2097_A2_JackJCharacter::MoveRight);

	// We have 2 versions of the rotation bindings to handle different kinds of devices differently
	// "turn" handles devices that provide an absolute delta, such as a mouse.
	// "turnrate" is for devices that we choose to treat as a rate of change, such as an analog joystick
	PlayerInputComponent->BindAxis("Turn", this, &APawn::AddControllerYawInput);
	PlayerInputComponent->BindAxis("TurnRate", this, &AFIT2097_A2_JackJCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AFIT2097_A2_JackJCharacter::LookUpAtRate);
}

void AFIT2097_A2_JackJCharacter::OnFire()
{
	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<AFIT2097_A2_JackJProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
				...
				World->SpawnActor<AFIT2097_A2_JackJProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
			}
		}
	}
...
void AFIT2097_A2_JackJCharacter::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void AFIT2097_A2_JackJCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AFIT2097_A2_JackJCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
//void AFIT2097_A2_JackJCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
void AFIT2097_A2_JackJCharacter::MoveForward(float Value)
{
	if (Value != 0.0f)
	{
...
void AFIT2097_A2_JackJCharacter::MoveRight(float Value)
{
	if (Value != 0.0f)
	{
		// add movement in that direction
...
void AFIT2097_A2_JackJCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AFIT2097_A2_JackJCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

bool AFIT2097_A2_JackJCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	if (FPlatformMisc::SupportsTouchInput() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AFIT2097_A2_JackJCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &AFIT2097_A2_JackJCharacter::EndTouch);

		//Commenting this out to be more consistent with FPS BP template.
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AFIT2097_A2_JackJCharacter::TouchUpdate);
		return true;
	}
...
FString AFIT2097_A2_JackJCharacter::MyRole()
{
...
bool AFIT2097_A2_JackJCharacter::Trace(
	UWorld* World,
...
void AFIT2097_A2_JackJCharacter::CallMyTrace()
{
